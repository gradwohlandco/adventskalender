...
const STORIES = [
  ...
  },
  {
    ...
    text: `Sie hatte den Brief schon dreimal neu geschrieben. Zu viele Wünsche, dann zu wenige, dann zu ordentliche Handschrift - das wirkte unecht. Schliesslich schrieb sie einfach: "Lieber Nikolaus, dieses Jahr wünsche ich mir, dass alle, die ich liebe, gesund bleiben. Alles andere ist Zugabe." Sie faltete den Brief sorgfältig und legte ihn auf die Fensterbank. Draussen begann es zu schneien.`
  },
  {
  ...
  },
  {
    ...
    text: `Es gibt eine Kunst, heisse Schokolade richtig zu machen. Nicht aus einem Päckchen, sondern langsam, mit echter Kuvertüre und warmer Milch, unter ständigem Rühren. Das Ergebnis ist dunkel, samtig, fast zu gut. Man hält die Tasse mit beiden Händen. Man trinkt langsam. Draussen schneit es vielleicht, oder es ist einfach kalt und grau - aber die Tasse macht einen eigenen kleinen Frieden.`
  },
  {
    title: "Das Konzert",
  ...
  {
    title: "Schneeball",
    text: `Es begann harmlos mit einem einzigen Schneeball. Wer ihn geworfen hatte, war hinterher nicht mehr festzustellen - alle beschuldigten alle, niemand bedauerte etwas. Die halbe Nachbarschaft stand draussen, Erwachsene warfen auf Kinder, Kinder auf Erwachsene, jemand traf aus Versehen den Hund, der daraufhin freudig mitmachte. Als es dunkel wurde, gingen alle lachend und durchgefroren nach Hause. Abendessen schmeckte an dem Abend besonders gut.`
  },
  {
    title: "Adventskranz",
    text: `Sie hatten ihn wieder zusammen gebastelt - ungleichmässig, mit zu viel Draht und einem Schleifenknoten, der schief sass. Aber er stand auf dem Tisch wie jedes Jahr, und die erste Kerze brannte ruhig und gleichmässig. Vier Sonntage, vier Lichter. Ein alter Rhythmus, der zuverlässiger kam als jeder Kalender. Manche Traditionen sind nicht wegen ihrer Schönheit wertvoll, sondern wegen ihrer Beständigkeit.`
  },
  {
  ...
  {
    title: "Stille Nacht",
    text: `Es gibt eine Stunde kurz nach Mitternacht im Dezember, in der alles still ist. Die Stadt hat aufgehört zu reden. Der Schnee dämpft jeden Ton. Man steht am Fenster und sieht in die leere Strasse, die im Lampenlicht golden schimmert, und spürt etwas, das schwer zu benennen ist - eine Vollständigkeit, als wäre dieser Moment genau richtig so. Nichts fehlt. Nichts ist zu viel. Nur Stille und Licht.`
  },
  {
  ...
  },
  {
    ...
    text: `Er stand nicht gerade, sein Schal sass schief, und die Nase - eigentlich eine Karotte - war etwas zu weit rechts geraten. Aber er stand. Die Kinder betrachteten ihr Werk mit dem Ernst von Künstlern vor einer Vernissage. "Er ist gut geworden", sagte die Ältere schliesslich. "Er ist der Beste", bestätigte der Kleine. Sie hatten recht. Er war der beste Schneemann, den es je gegeben hatte.`
  },
  {
    title: "Heiligabend",
  ...
  },
  {
    ...
    text: `Alle waren ein bisschen müde und ein bisschen aufgeregt. Der Supermarkt war chaotisch, die Strassen voll, die To-do-Liste noch nicht fertig. Aber dann, auf dem Heimweg, lag Schnee - dicker, echter, neuer Schnee - und plötzlich war alles halb so schlimm. Man blieb kurz stehen, liess eine Schneeflocke auf die Hand fallen, sah ihr beim Schmelzen zu. Manchmal braucht es nicht mehr als das.`
  },
  {
